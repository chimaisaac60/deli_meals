    ...
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          textTheme: ThemeData.light().textTheme.copyWith(
              bodyText1: TextStyle(
                color: Color.fromARGB(100, 51, 51, 1),
              ),
              // bodyText2: TextStyle(
      ...
      routes: {
        ...
        MealDetailScreen.routeNamed: (ctx) => MealDetailScreen(_toggleFavorite,_isMealFavorite),
        FliterScreen.routeNamed: (ctx) => FliterScreen(_filters, _setFilters),
      },
